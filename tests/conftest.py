...
import src.components as _sc  # noqa: E402

_COMP_SRC = (Path(__file__).parents[1] / "src" / "components").resolve()
if str(_COMP_SRC) not in _sc.__path__:
    _sc.__path__.insert(0, str(_COMP_SRC))
...
_translator.load_domain("com_audit", _COMP_SRC / "com_audit" / "i18n")

from jinja2 import FileSystemLoader  # noqa: E402
from src.core.templates import admin_templates  # noqa: E402

_COMP_TEMPLATES = _COMP_SRC / "com_audit" / "templates"
if not any(
    isinstance(ldr, FileSystemLoader) and str(_COMP_TEMPLATES) in ldr.searchpath
...
if not any(
    ...
    _cms_app.include_router(_audit_admin.router)
...
async def _seed(session: AsyncSession) -> None:
    ...
    session.add(SystemSettings(
        ...
        rate_limit_paid="10000/hour",
        login_max_attempts=3,
        login_lockout_minutes=1,
        marketplace_url="https://marketplace.klucon.cz",
